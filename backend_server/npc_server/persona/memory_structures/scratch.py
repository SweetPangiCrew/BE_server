...
class Scratch: 
  def __init__(self, f_saved): 
    ...
    self.curr_time = None
    # Current x,y tile coordinate of the persona. legacy
    #self.curr_tile = None
    # Current address percieved by front-end
    ...
    if check_if_file_exists(f_saved): 
      ...
      if scratch_load["curr_time"]: 
        ...
        self.curr_time = None
      self.curr_address = scratch_load["curr_address"]
  ...
  def save(self, out_json):
    ...
    scratch["curr_address"] = self.curr_address
  ...
  def get_curr_address_arena(self):
    return self.curr_address.split(":")[2]  
